...
# custom topic: *ID = random-string CAA..... https://news.google.com/rss/topics/{id}?hl={lang}
...
# Finds the top 7 sentences and prints them based on their scores
    ...
    print(summary)
    with open('googleNews' + datetime.now().strftime("%d-%m-%Y_%I-%M-%S_%p")
 + '.txt', 'a') as file: # 'wa' is write append mode
          file.write(article)
